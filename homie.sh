...
mosquitto_pub -r -h 192.168.0.59 -t 'homie/living-room-temp/temperature/temp/$datatype' -m 'float'
...
mosquitto_pub -r -h 192.168.0.59 -t 'homie/living-room-temp/temperature/hum/$datatype' -m 'float'
...
mosquitto_pub -r -h 192.168.0.59 -t 'homie/living-room-temp/temperature/p/$datatype' -m 'float'
